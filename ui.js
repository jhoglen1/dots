(function () {
    ...
    var _elm_lang$core$Native_Utils = function () { // COMPARISONS
        ...
        function append(xs, ys) { // append Strings
            if (typeof xs === 'string') {
                return xs + ys;
            }
    ...
    var _elm_lang$core$Native_Platform = function () { // PROGRAMS
        ...
        function gatherEffects(isCmd, bag, effectsDict, taggers) {
            switch (bag.type) {
                ...
                case 'map': gatherEffects(isCmd, bag.tree, effectsDict, {
                        tagger: bag.tagger,
                        rest: taggers
                    });
                    return;
        ...
        function setupOutgoingPort(name) {
            ...
            function onEffects(router, cmdList, state) {
                while (cmdList.ctor !== '[]') { // grab a separate reference to subs in case unsubscribe is called
    ...
    _elm_lang$core$Platform_Cmd_ops['!'] = F2(function (model, commands) {
        return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$batch(commands)};
    });
    ...
    var _elm_lang$core$Native_String = function () {
        ...
        function toFloat(s) { // check if it is a hex, octal, or binary number
    ...
    var _elm_lang$core$Native_Time = function () {
        ...
        return {now: now, setInterval_: F2(setInterval_)};
        ...
        function badToString(problem) {
            ...
            while (problem) {
                switch (problem.tag) {
                    ...
                    case 'index': context += '[' + problem.index + ']';
                        problem = problem.rest;
                        break;

                    case 'field': context += '.' + problem.field;
                        problem = problem.rest;
                        break;
    ...
    var _elm_lang$virtual_dom$Native_VirtualDom = function () {
        ...
        function applyFacts(domNode, eventNode, facts) {
            for (var key in facts) {
                ...
                switch (key) {
                    case STYLE_KEY: applyStyles(domNode, value);
                        break;

                    case EVENT_KEY: applyEvents(domNode, eventNode, value);
                        break;

                    case ATTR_KEY: applyAttrs(domNode, value);
                        break;

                    case ATTR_NS_KEY: applyAttrsNS(domNode, value);
                        break;
        ...
        function applyPatch(domNode, patch) {
            switch (patch.type) {
                ...
                case 'p-facts': applyFacts(domNode, patch.eventNode, patch.data);
                    return domNode;

                case 'p-text': domNode.replaceData(0, domNode.length, patch.data);
                    return domNode;
        ...
        function makeStepper(domNode, view, initialVirtualNode, eventNode) {
            ...
            function updateIfNeeded() {
                switch (state) {
                    ...
                    case 'PENDING_REQUEST': rAF(updateIfNeeded);
                        state = 'EXTRA_REQUEST';
                    ...
                    case 'EXTRA_REQUEST': state = 'NO_REQUEST';
                        return;
                }
            }
    ...
    var _elm_lang$http$Native_Http = function () { // ENCODING AND DECODING
        ...
        function send(xhr, body) {
            switch (body.ctor) {
                case 'EmptyBody': xhr.send();
                    return;

                case 'StringBody': xhr.setRequestHeader('Content-Type', body._0);
                    xhr.send(body._1);
                    return;

                case 'FormDataBody': xhr.send(body._0);
                    return;
            }
        }
        ...
        function handleResponse(xhr, responseToResult) {
            ...
            if (xhr.status < 200 || 300 <= xhr.status) {
                ...
                return _elm_lang$core$Native_Scheduler.fail({ctor: 'BadStatus', _0: response});
            }
            ...
            if (result.ctor === 'Ok') {
                ...
                response.body = xhr.responseText;
                return _elm_lang$core$Native_Scheduler.fail({ctor: 'BadPayload', _0: result._0, _1: response});
            }
        }
    ...
    var _elm_lang$websocket$Native_WebSocket = function () {
        ...
        function open(url, settings) {
            return _elm_lang$core$Native_Scheduler.nativeBinding(function (callback) {
                ...
                socket.addEventListener("close", function (event) {
                    _elm_lang$core$Native_Scheduler.rawSpawn(settings.onClose({code: event.code, reason: event.reason, wasClean: event.wasClean}));
                });
        ...
        return {open: F2(open), send: F2(send), close: F3(close), bytesQueued: bytesQueued};
    ...
    var _elm_lang$websocket$WebSocket_LowLevel$WebSocket = {
        ctor: 'WebSocket'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$BadArgs = {
        ctor: 'BadArgs'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$BadSecurity = {
        ctor: 'BadSecurity'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$BadReason = {
        ctor: 'BadReason'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$BadCode = {
        ctor: 'BadCode'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$BadString = {
        ctor: 'BadString'
    };
    var _elm_lang$websocket$WebSocket_LowLevel$NotOpen = {
        ctor: 'NotOpen'
    };
                ...
                if (_p2._0.ctor === 'Listen') {
                    ...
                    var _v5 = _p2._1,
                        _v6 = A3(_elm_lang$core$Dict$update, _p2._0._0, function (_p3) {
                            return _elm_lang$core$Maybe$Just(A2(_elm_lang$core$Maybe$withDefault, {
                                ctor: '[]'
                            }, _p3));
                        }, dict);
                    subs = _v5;
    ...
    var _elm_lang$websocket$WebSocket$onSelfMsg = F3(function (router, selfMsg, state) {
        ...
        switch (_p19.ctor) {
            case 'Receive':
                ...
                }, A2(_elm_lang$core$Maybe$withDefault, {
                    ctor: '[]'
    ...
    var _user$project$Model$Client = {
        ctor: 'Client'
    };
    var _user$project$Model$NoOp = {
        ctor: 'NoOp'
    };
    ...
    var _user$project$Decoder$point = A3(_elm_lang$core$Json_Decode$map2, _user$project$Model$Point, A2(_elm_lang$core$Json_Decode$field, 'x', _elm_lang$core$Json_Decode$int), A2(_elm_lang$core$Json_Decode$field, 'y', _elm_lang$core$Json_Decode$int));
    var _user$project$Decoder$line = A3(_elm_lang$core$Json_Decode$map2, _user$project$Model$Line, A2(_elm_lang$core$Json_Decode$field, 'start', _user$project$Decoder$point), A2(_elm_lang$core$Json_Decode$field, 'end', _user$project$Decoder$point));
    var _user$project$Decoder$statePayload = A4(_elm_lang$core$Json_Decode$map3, _user$project$Model$StatePayload, _elm_lang$core$Json_Decode$maybe(A2(_elm_lang$core$Json_Decode$field, 'newLine', _user$project$Decoder$line)), _elm_lang$core$Json_Decode$maybe(A2(_elm_lang$core$Json_Decode$field, 'heading', _elm_lang$core$Json_Decode$string)), _elm_lang$core$Json_Decode$maybe(A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$string)));
    var _user$project$Decoder$webSocketResponse = A4(_elm_lang$core$Json_Decode$map3, _user$project$Model$WebSocketResponse, A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$int), A2(_elm_lang$core$Json_Decode$field, 'msg', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'body', _user$project$Decoder$statePayload));
    ...
    var _user$project$Decoder$apiResponse = A3(_elm_lang$core$Json_Decode$map2, _user$project$Model$ApiResponse, A2(_elm_lang$core$Json_Decode$field, 'msg', _elm_lang$core$Json_Decode$string), A2(_elm_lang$core$Json_Decode$field, 'body', _user$project$Decoder$statePayload));
    ...
    var _user$project$Encoder$webSocketRequestToJson = F2(function (request, encodeBody) {
        return A2(_elm_lang$core$Json_Encode$encode, 0, A2(_user$project$Encoder$webSocketRequest, request, encodeBody));
    });
    ...
    var _user$project$Encoder$clientRequestToJson = F2(function (request, encodeBody) {
        return A2(_elm_lang$core$Json_Encode$encode, 0, A2(_user$project$Encoder$clientRequest, request, encodeBody));
    });
    ...
    var _user$project$Port$request = _elm_lang$core$Native_Platform.outgoingPort('request', function (v) {
        return v;
    });
    var _user$project$Port$response = _elm_lang$core$Native_Platform.incomingPort('response', A2(_elm_lang$core$Json_Decode$andThen, function (msg) {
        return A2(_elm_lang$core$Json_Decode$andThen, function (body) {
            return _elm_lang$core$Json_Decode$succeed({msg: msg, body: body});
        }, A2(_elm_lang$core$Json_Decode$field, 'body', A2(_elm_lang$core$Json_Decode$andThen, function (newLine) {
            return A2(_elm_lang$core$Json_Decode$andThen, function (heading) {
                return A2(_elm_lang$core$Json_Decode$andThen, function (message) {
                    return _elm_lang$core$Json_Decode$succeed({newLine: newLine, heading: heading, message: message});
                }, A2(_elm_lang$core$Json_Decode$field, 'message', _elm_lang$core$Json_Decode$oneOf({
                    ctor: '::',
                    _0: _elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
                    _1: {
                        ctor: '::',
            ...
            }, A2(_elm_lang$core$Json_Decode$field, 'heading', _elm_lang$core$Json_Decode$oneOf({
                ctor: '::',
                _0: _elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
                _1: {
                    ctor: '::',
        ...
        }, A2(_elm_lang$core$Json_Decode$field, 'newLine', _elm_lang$core$Json_Decode$oneOf({
            ctor: '::',
            _0: _elm_lang$core$Json_Decode$null(_elm_lang$core$Maybe$Nothing),
            _1: {
                ctor: '::',
                _0: A2(_elm_lang$core$Json_Decode$map, _elm_lang$core$Maybe$Just, A2(_elm_lang$core$Json_Decode$andThen, function (start) {
                    return A2(_elm_lang$core$Json_Decode$andThen, function (end) {
                        return _elm_lang$core$Json_Decode$succeed({start: start, end: end});
                    }, A2(_elm_lang$core$Json_Decode$field, 'end', A2(_elm_lang$core$Json_Decode$andThen, function (x) {
                        return A2(_elm_lang$core$Json_Decode$andThen, function (y) {
                ...
                }, A2(_elm_lang$core$Json_Decode$field, 'start', A2(_elm_lang$core$Json_Decode$andThen, function (x) {
                    return A2(_elm_lang$core$Json_Decode$andThen, function (y) {
                        return _elm_lang$core$Json_Decode$succeed({x: x, y: y});
                    }, A2(_elm_lang$core$Json_Decode$field, 'y', _elm_lang$core$Json_Decode$int));
                }, A2(_elm_lang$core$Json_Decode$field, 'x', _elm_lang$core$Json_Decode$int))))),
    ...
    var _user$project$Port$startTimer = _elm_lang$core$Native_Platform.outgoingPort('startTimer', function (v) {
        return v;
    });
    ...
    var _user$project$Update$httpNodeClicked = F2(function (hostname, point) {
        ...
        return A3(_elm_lang$http$Http$post, A2(_elm_lang$core$Basics_ops['++'], hostname, '/node-clicked'), body, _user$project$Decoder$apiResponse);
    });
    var _user$project$Update$httpInitialize = function (hostname) {
        return A2(_elm_lang$http$Http$get, A2(_elm_lang$core$Basics_ops['++'], hostname, '/initialize'), _user$project$Decoder$apiResponse);
    };
    var _user$project$Update$httpError = F2(function (hostname, error) {
        ...
        return A3(_elm_lang$http$Http$post, A2(_elm_lang$core$Basics_ops['++'], hostname, '/error'), body, _user$project$Decoder$apiResponse);
    });
    ...
    var _user$project$Update$updateState = F3(function (model, msg, state) {
        var newModel = function () {
            ...
            if (_p3.ctor === 'Just') {
                ...
                return _elm_lang$core$Native_Utils.eq(msg, 'INVALID_START_NODE') ? _elm_lang$core$Native_Utils.update(model, {activeNode: _elm_lang$core$Maybe$Nothing}) : model;
            }
        }();
        return {
            ctor: '_Tuple2',
        ...
        switch (_p4.ctor) {
            ...
            case 'Http':
                return {
                    ctor: '_Tuple2',
                    _0: newModel,
                    _1: A2(_elm_lang$http$Http$send, _user$project$Model$HttpError, A2(_user$project$Update$httpError, _p4._0, error))
                };
            default:
    ...
    var _user$project$Update$activateNode = F2(function (model, point) {
        ...
        switch (_p8.ctor) {
            case 'Client':
                ...
                return {ctor: '_Tuple2', _0: newModel, _1: _user$project$Port$request(body)};
            case 'Http':
                return {
                    ctor: '_Tuple2',
                    _0: newModel,
                    _1: A2(_elm_lang$http$Http$send, _user$project$Model$NewHttpResponse, A2(_user$project$Update$httpNodeClicked, _p8._0, point))
                };
            default:
                var _p9 = _p8._0;
    ...
    var _user$project$Update$init = function (flags) {
        ...
        var model = _elm_lang$core$Native_Utils.update(_user$project$Update$initialModel, {selectedApi: selectedApi});
        ...
        switch (_p13.ctor) {
            case 'Client':
                ...
                return {ctor: '_Tuple2', _0: model, _1: _user$project$Port$request(body)};
            case 'Http':
                return {
                    ctor: '_Tuple2',
                    _0: model,
                    _1: A2(_elm_lang$http$Http$send, _user$project$Model$NewHttpResponse, _user$project$Update$httpInitialize(_p13._0))
                };
            default:
                var _p14 = _p13._0;
    ...
    var _user$project$View$genGridCoords = F2(function (columns, rows) {
        return _elm_lang$core$List$concat(A2(_elm_lang$core$List$map, function (x) {
            return A2(_elm_lang$core$List$map, function (y) {
    ...
    var _user$project$View$lineSegment = F3(function (cellSize, nodeHandleRadius, _p1) {
        ...
        var _p4 = _p2.start;
        var _p3 = _p2.end;
        return A2(_elm_lang$svg$Svg$line, {
            ctor: '::',
            _0: _elm_lang$svg$Svg_Attributes$x1(_elm_lang$core$Basics$toString((_p4.x * cellSize) + nodeHandleRadius)),
            _1: {
                ctor: '::',
                _0: _elm_lang$svg$Svg_Attributes$y1(_elm_lang$core$Basics$toString((_p4.y * cellSize) + nodeHandleRadius)),
                _1: {
                    ctor: '::',
                    _0: _elm_lang$svg$Svg_Attributes$x2(_elm_lang$core$Basics$toString((_p3.x * cellSize) + nodeHandleRadius)),
                    _1: {
                        ctor: '::',
                        _0: _elm_lang$svg$Svg_Attributes$y2(_elm_lang$core$Basics$toString((_p3.y * cellSize) + nodeHandleRadius)),
                        _1: {
                            ctor: '[]'
                        }
                    }
    ...
    var _user$project$View$lineSegments = function (_p5) {
        var _p6 = _p5;
        var lineSegmentList = A2(_elm_lang$core$List$map, A2(_user$project$View$lineSegment, _p6.cellSize, _p6.nodeHandleRadius), _p6.lines);
        return A2(_elm_lang$svg$Svg$g, {
            ctor: '::',
            _0: _elm_lang$svg$Svg_Attributes$stroke('grey'),
            _1: {
                ctor: '::',
                _0: _elm_lang$svg$Svg_Attributes$strokeWidth(_elm_lang$core$Basics$toString(_p6.lineWidth)),
                _1: {
                    ctor: '[]'
                }
            }
    ...
    var _user$project$View$nodeHandle = F4(function (awaitingResponse, cellSize, nodeRadius, point) {
        return A2(_elm_lang$svg$Svg$circle, {
            ctor: '::',
            _0: _elm_lang$svg$Svg_Attributes$cx(_elm_lang$core$Basics$toString((point.x * cellSize) + nodeRadius)),
            _1: {
                ctor: '::',
                _0: _elm_lang$svg$Svg_Attributes$cy(_elm_lang$core$Basics$toString((point.y * cellSize) + nodeRadius)),
                _1: {
                    ctor: '::',
                    _0: _elm_lang$svg$Svg_Attributes$r(_elm_lang$core$Basics$toString(nodeRadius)),
                    _1: {
                        ctor: '::',
                        _0: _elm_lang$svg$Svg_Events$onClick(awaitingResponse ? _user$project$Model$NoOp : _user$project$Model$ActivateNode(point)),
                        _1: {
                            ctor: '::',
    ...
    var _user$project$View$nodeHandles = F2(function (model, nodeCoordinates) {
        ...
        var nodeList = A2(_elm_lang$core$List$map, A3(_user$project$View$nodeHandle, awaitingResponse, cellSize, nodeHandleRadius), nodeCoordinates);
        return A2(_elm_lang$svg$Svg$g, {
            ctor: '[]'
        }, nodeList);
    });
    var _user$project$View$node = F5(function (cellSize, nodeRadius, nodeHandleRadius, activeNode, point) {
        ...
        return A2(_elm_lang$svg$Svg$circle, {
            ctor: '::',
            _0: _elm_lang$svg$Svg_Attributes$cx(_elm_lang$core$Basics$toString((point.x * cellSize) + nodeHandleRadius)),
            _1: {
                ctor: '::',
                _0: _elm_lang$svg$Svg_Attributes$cy(_elm_lang$core$Basics$toString((point.y * cellSize) + nodeHandleRadius)),
                _1: {
                    ctor: '::',
                    _0: _elm_lang$svg$Svg_Attributes$r(_elm_lang$core$Basics$toString(nodeRadius)),
                    _1: {
    ...
    var _user$project$View$nodes = F2(function (model, nodeCoordinates) {
        ...
        var nodeList = A2(_elm_lang$core$List$map, A4(_user$project$View$node, cellSize, nodeRadius, nodeHandleRadius, activeNode), nodeCoordinates);
        return A2(_elm_lang$svg$Svg$g, {
            ctor: '[]'
        }, nodeList);
    });
    var _user$project$View$grid = function (model) {
        ...
        return A2(_elm_lang$svg$Svg$svg, {
            ctor: '::',
    ...
    var _user$project$View$heading = function (maybeHeadingText) {
        ...
        if (_p11.ctor === 'Just') {
            return A2(_elm_lang$html$Html$h1, {
                ctor: '::',
    ...
    var _user$project$Main$main = _elm_lang$html$Html$programWithFlags({init: _user$project$Update$init, view: _user$project$View$view, update: _user$project$Update$update, subscriptions: _user$project$Update$subscriptions})(A2(_elm_lang$core$Json_Decode$andThen, function (api) {
        return A2(_elm_lang$core$Json_Decode$andThen, function (hostname) {
